...
from .grpo_utils import accuracy_reward, format_reward, get_cosine_scaled_reward, reasoning_steps_reward
...
def run_grpo(
    ...
    REWARD_FUNCS_REGISTRY = {
        ...
        "cosine": get_cosine_scaled_reward(
            min_value_wrong=finetuning_args.cosine_min_value_wrong,
            max_value_wrong=finetuning_args.cosine_max_value_wrong,
            min_value_correct=finetuning_args.cosine_min_value_correct,
            max_value_correct=finetuning_args.cosine_max_value_correct,
            max_len=finetuning_args.cosine_max_len,
        ),
    }
    reward_funcs = [REWARD_FUNCS_REGISTRY[func] for func in finetuning_args.reward_funcs]

    # Initialize our Trainer
    grpo_trainer: "CustomGRPOTrainer" = CustomGRPOTrainer(
